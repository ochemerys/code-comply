...
/**
 * DeleteDeficiencyDialog — mobile-first confirmation for deficiency removal (M6-S11).
 */
...
<template>
  <BottomSheet
    ...
    role="alertdialog"
    labelled-by="delete-deficiency-dialog-title"
    described-by="delete-deficiency-dialog-desc"
    overlay-test-id="delete-deficiency-dialog-overlay"
    data-testid="delete-deficiency-dialog"
    @update:model-value="onSheetModelUpdate"
    @close="onSheetClose"
  >
    <div class="flex-shrink-0 border-b border-border-subtle px-5 py-4">
      <h2
        id="delete-deficiency-dialog-title"
        class="text-lg font-semibold text-gray-900 dark:text-gray-100"
        data-testid="delete-deficiency-dialog-title"
      >
        Delete Deficiency?
      </h2>
      <p
        id="delete-deficiency-dialog-desc"
        class="mt-1 text-sm text-text-secondary"
        data-testid="delete-deficiency-dialog-message"
      >
        This action cannot be undone.
      </p>
    </div>

    <div class="px-5 py-4" data-testid="delete-deficiency-dialog-summary">
      ...
      <div class="mt-2 flex flex-wrap items-center gap-2">
        <span
          ...
          data-testid="delete-deficiency-dialog-severity"
        >
      ...
      <p
        ...
        data-testid="delete-deficiency-dialog-description"
      >
        {{ summaryDescription }}
      </p>
    ...
    <p
      ...
      data-testid="delete-deficiency-dialog-error"
      role="alert"
    >
      {{ error }}
    </p>
    ...
    >
      <button
        type="button"
        class="h-12 min-h-[44px] flex-1 rounded-lg bg-red-600 px-4 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 disabled:cursor-not-allowed disabled:opacity-60"
        data-testid="delete-deficiency-dialog-confirm"
        :disabled="deleting"
        :aria-busy="deleting"
        @click="onConfirm"
      >
        <span v-if="deleting" data-testid="delete-deficiency-dialog-deleting">Deleting…</span>
      ...
      <button
        ...
        data-testid="delete-deficiency-dialog-cancel"
        :disabled="deleting"
        @click="onCancel"
      >
        Cancel
