 ...
 * See scripts/operations-runbook-audit.mjs and _docs/development/03-implementation/m11-s24-operations-runbook-checklist.md.
 */
...
export const OPERATIONS_RUNBOOK_ARTIFACT_PATHS = {
  runbook: '_docs/operations/runbook.md',
  incidentResponse: '_docs/operations/incident-response.md',
  ...
  checklist: '_docs/development/03-implementation/m11-s24-operations-runbook-checklist.md',
